          ...
          {selectedTab === "projects" && (
            <section className="h-full w-full">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 w-full h-full ">
                ...
                <ProjectTemplate title={project.title} subTitle={project.subTitle} coverVideoLink={project.coverVideoLink} about={project.about} webLink={project.webLink} gitLink={project.gitLink} mainCoverLink={project.mainCoverLink} badges={project.badges} type={project.type}/>
                </div>
