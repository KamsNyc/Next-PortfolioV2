  ...
  return (
    <div className="flex items-center justify-center w-full py-2 px-4">
      ...
      <div
        ...
        className="w-60 h-8 z-40 md:z-2 rounded-xl absolute bg-white/10 hover:bg-black/70 text-white/30 hover:text-white bottom-5 left-[50%] translate-x-[-50%] translate -y-[-50%] flex items-center justify-center cursor-pointer hover:scale-110 duration-300 ease-in"
      >
        Write Review
      </div>
