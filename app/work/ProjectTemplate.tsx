            ...
            <SheetHeader>
              ...
              <SheetDescription className="h-full text-left px-2">
                <div className="overflow-y-auto h-full">
                  ...
                  <div id='Badges' className="flex flex-wrap items-center gap-4 py-2">
                    {
              ...
              <div className="flex flex-col md:flex-row w-full gap-8 pt-4 px-4">
                <Button className='w-full md:w-auto text-white' variant="outline"><Link href={`${webLink}`}>View Website</Link></Button>
                <Button className='w-full md:w-auto text-white' variant="outline"><Link href={`${gitLink}`}>Github</Link></Button>
              </div>
            </SheetHeader>
          </ScrollArea>
        </SheetContent>
